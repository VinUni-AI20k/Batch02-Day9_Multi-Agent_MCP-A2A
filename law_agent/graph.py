...
async def check_routing(state: LawState) -> dict:
    ...
    needs_tax = any(kw in question_lower for kw in ["tax", "irs", "thuế", "evasion", "fbar", "fatca", "pricing"])
    needs_compliance = any(kw in question_lower for kw in ["compliance", "sec", "sox", "sarbanes", "fcpa", "aml", "regulation", "bribery"])
