...
async def call_privacy_specialist(state: LegalState) -> dict:
    ...
    privacy_prompt = (
        ...
        "data protection laws, and data breach liability. "
        "Use the search_compliance_law tool to ground your analysis. Keep your response under 200 words."
    )
...
QUESTION = "If a startup company leaks customer data and evades taxes, what are the legal and regulatory consequences under GDPR and tax laws?"
