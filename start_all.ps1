...
Start-Process "uv" -ArgumentList "run python -m registry" -WindowStyle Normal
Start-Sleep -Seconds 2

Write-Host "Starting Tax Agent on port 10102..."
Start-Process "uv" -ArgumentList "run python -m tax_agent" -WindowStyle Normal

Write-Host "Starting Compliance Agent on port 10103..."
Start-Process "uv" -ArgumentList "run python -m compliance_agent" -WindowStyle Normal
Start-Sleep -Seconds 3

Write-Host "Starting Law Agent on port 10101..."
Start-Process "uv" -ArgumentList "run python -m law_agent" -WindowStyle Normal
Start-Sleep -Seconds 3

Write-Host "Starting Customer Agent on port 10100..."
Start-Process "uv" -ArgumentList "run python -m customer_agent" -WindowStyle Normal
